...
| NNTP response timeout | `usenet.nntp-read-timeout-seconds` | `30` | Maximum stalled protocol read for BODY, ARTICLE, STAT, and other NNTP responses, 5–120 seconds |
| Replacement reconnect spacing | `usenet.reconnect-delay-milliseconds` | `500` | Minimum spacing between replacement handshakes after a poisoned connection is closed, 0–5000 milliseconds |
